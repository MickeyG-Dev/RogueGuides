...
Setup Steps
Download Ghost using the link above.
Temporarily disable antivirus if required.
Close all games and launchers completely.
Right-click Ghost and select Run as Administrator.
Wait for the spoofing process to complete.
Launch your game or application after completion.
Important Notes
...
Scroll to the bottom of System Summary
Confirm the following all say Yes:
